...
appreciated!  pysat and pysatSeasons are a community-driven projects that
...
When [reporting a bug](https://github.com/pysat/pysatSeasons/issues) please
include:
...
[issue](https://github.com/pysat/pysatSeasons/issues).
...
1. [Fork pysatSeasons on GitHub](https://github.com/pysat/pysatSeasons/fork).
...
3. Create a branch for local development:
  ...
  ```
   ...
   in ``pysatSeasons/tests``. For example, custom functions for the time
